...
<div id="posterBox">
<div id="boxx">
	<a class="film">Film</a><a class="flow">Match</a>&emsp;
...
<div id="boxb">
	...
	<div>
			<a class="carousel-control-prev" href="#demo" data-slide="prev">
		 	<i class="material-icons" style="font-size:70px;color:black"onclick="moveImage_right();">fast_rewind</i></a>&emsp;&emsp;
			<a class="carousel-control-next" href="#demo" data-slide="next">
			<i class="material-icons" style="font-size:70px;color:black"onclick="moveImage_left();">fast_forward</i></a>
	</div>
	</div>
...
<div>
			<a class="carousel-control-prev" href="#demo" data-slide="prev">
		 	<i class="material-icons" style="font-size:70px;color:black"onclick="moveImage_rightd();">fast_rewind</i></a>&emsp;&emsp;
			<a class="carousel-control-next" href="#demo" data-slide="next">
			<i class="material-icons" style="font-size:70px;color:black"onclick="moveImage_leftd();">fast_forward</i></a>
	</div>
	</div>
<div id="text3">
	<h1 >평균별점이 높은 순위</h1>
...
<div>
			<a class="carousel-control-prev" href="#demo" data-slide="prev">
		 	<i class="material-icons" style="font-size:70px;color:black"onclick="moveImage_rightf();">fast_rewind</i></a>&emsp;&emsp;
			<a class="carousel-control-next" href="#demo" data-slide="next">
			<i class="material-icons" style="font-size:70px;color:black"onclick="moveImage_leftf();">fast_forward</i></a>
	</div>
	</div>
	</div>
<br>
