...
<link rel="stylesheet" href="${ pageContext.request.contextPath }/css/main/main.css">
	...
	<body class="sb-nav-fixed">
		<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
			...
			<!-- <a href="../movie_main.do" class="navbar-brand ps-3 logo"><span class="film">Film</span><span class="flow">Match</span></a> -->
			<a href="movie_main.do" class="logo"><span class="film_white">Film</span><span class="flow">Match</span></a>
