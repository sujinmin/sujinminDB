...
$("#img2").hover(
		function(){
			$("#img2").css("border","2px solid black");
			$("#img2").css("color", "rgba(0, 0, 0, 0.5)");
			var src = $("#imga img").attr("src");
			
			$("#img1").prop("src",src);
		}, function(){
			$("#img2").css("color", "rgba(0, 0, 0, 1)");
			$("#img2").css("border","2px solid white");
		});
// li 에 마우스 올라오면 영화정보를 
// 보여주게 설정
...
$("#img3").hover(
	function(){
		$("#img3").css("border","2px solid black");
		$("#img3").css("color", "rgba(0, 0, 0, 0.5)");
		var src = $("#imgb img").attr("src");
		$("#img1").prop("src",src);
	}, function(){
		$("#img3").css("color", "rgba(0, 0, 0, 1)");
		$("#img3").css("border","2px solid white");
	});

	$("#img4").hover(
		function(){
			$("#img4").css("border","2px solid black");
			$("#img4").css("color", "rgba(0, 0, 0, 0.5)");
			var src = $("#imgc img").attr("src");
		$("#img1").prop("src",src);
		}, function(){
			$("#img4").css("color", "rgba(0, 0, 0, 1)");
			$("#img4").css("border","2px solid white");
		});

		$("#img5").hover(
			function(){
				$("#img5").css("border","2px solid black");
				$("#img5").css("color", "rgba(0, 0, 0, 0.5)");
				var src = $("#imgd img").attr("src");
				$("#img1").prop("src",src);
			}, function(){
				$("#img5").css("color", "rgba(0, 0, 0, 1)");
				$("#img5").css("border","2px solid white");
			});	
